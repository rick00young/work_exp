...
- [ ] 1. 擅长PHP,Python,Javascript,Shell,Lua了解Object-C,Swift,Java,C++.
- [x] 2. 具有良好编码风格,结构清晰,命名规范,逻辑性强.
- [x] 3. 利用业余时间维护一些项目.地址:[https://github.com/rick00young](https://github.com/rick00young).
